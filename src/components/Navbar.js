        ...
        <div className='h-15 p-5 flex item-left justify-left bg-red-400'>
            ...
            <div className='relative'>
                <div className='flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none'>
                    ...
                    <input type='search' id='buscador' className='block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rouded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder="Buscar pokemon..." required />
